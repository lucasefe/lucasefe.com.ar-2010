--- 
layout: post
title: "Rails 2.3.x y Ruby 1.9, en espa\xF1ol"
---
...
"GIST":http://gist.github.com/323648

<filter:code lang="ruby">namespace :encoding do
...
La data inicial de cómo resolver esto la sacamos de un post de "Akita":http://akitaonrails.com/2010/01/04/fixes-para-ruby-1-9-rails-2-3-x-e-unicode 

"GIST":http://gist.github.com/271196

<filter:code lang="ruby">require 'mysql'
...
<filter:code lang="ruby">RAILS_GEM_VERSION = '2.3.5' unless defined? RAILS_GEM_VERSION
...
* "Fixes para Ruby 1.9, Rails 2.3.x e Unicode":http://akitaonrails.com/2010/01/04/fixes-para-ruby-1-9-rails-2-3-x-e-unicode Hay que leer un poco de portugués. 
* "Understanding M17n":http://blog.grayproductions.net/articles/understanding_m17n
* Ruby Programming 3rd. edition
* "RVM":http://rvm.beginrescueend.com/
* "GIST1":http://gist.github.com/323648 y  "GIST2":http://gist.github.com/271196
